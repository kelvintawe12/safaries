  ...
  return (
    <footer className="relative bg-gradient-to-b from-blue-950 via-blue-900 to-blue-800 text-gray-200 overflow-hidden">
      ...
      <div className="relative container mx-auto px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
          ...
          <div className="lg:col-span-2">
            <div className="flex flex-col items-start mb-10">
              <svg
                className="h-24 w-auto mb-8 animate-logo-glow"
                viewBox="0 0 220 100"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
                  d="M30 70 C50 70 70 50 90 50 C110 50 130 70 150 70"
                  stroke="#f97316"
                  strokeWidth="5"
                  className="animate-path-draw"
                />
                <path
                  d="M150 70 L170 50 L190 70"
                  stroke="#f97316"
                  strokeWidth="5"
                  className="animate-path-draw delay-200"
                />
              ...
              <p className="text-blue-200 mb-8 max-w-lg leading-relaxed text-base font-light">
                Embark on a journey through Africa's soul with Kivu Safaris. Our sustainable adventures weave authentic
                cultural experiences into unforgettable memories.
              </p>
          ...
          {footerLinks.map((section, index) => (
            <div key={index}>
              <h3 className="text-2xl font-semibold mb-6 text-orange-400 tracking-tight font-['Playfair Display']">
                {section.title}
              </h3>
              <ul className="space-y-5">
                {section.links.map((link, linkIndex) => (
                  <li key={linkIndex}>
                    <Link
                      to={link.path}
                      className="text-blue-200 hover:text-white hover:underline decoration-orange-400 underline-offset-4 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 rounded text-base font-light"
                    >
                      {link.label}
                    </Link>
                  </li>
          ...
          <div className="max-w-xl mx-auto text-center">
            ...
            <div className="flex gap-4">
              <input
                ...
                className="flex-1 px-5 py-4 rounded-lg bg-blue-800 text-white border border-blue-700 focus:outline-none focus:ring-2 focus:ring-orange-400 transition-all duration-300 text-base font-light"
                aria-label="Email for newsletter subscription"
              />
              <button
                type="button"
                className="px-8 py-4 bg-orange-500 text-blue-900 rounded-lg hover:bg-orange-400 transform hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 font-semibold"
              >
                Subscribe
              </button>
            </div>
        ...
        <div className="border-t border-blue-700 mt-12 pt-10 text-center">
          <p className="text-blue-300 text-sm font-light">
            ...
            <Link
              to="/accessibility"
              className="hover:text-white hover:underline decoration-orange-400 underline-offset-4 transition-all duration-300 inline-block mt-3"
            >
      ...
      <button
        ...
        className="fixed bottom-8 left-8 p-4 bg-orange-500 text-blue-900 rounded-full shadow-2xl hover:bg-orange-400 transform hover:scale-110 hover:rotate-12 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2"
